...
#pragma region set
	...
	//
	//set.insert("Project Wingman");
	//set.insert("Ace Combat");
	//set.insert("HAWX");
	//set.insert("Chorus");
	//
...
//std::map<std::string, Quest> quest_list;
//
//quest_list["The Lost Heirloom"] = { 'D',false,"ABC" };
//quest_list["B"] = { 'D',false,"BBB" };
//quest_list["C"] = { 'C',false,"CCC" };
//
//for (const auto& element : quest_list)
//{
